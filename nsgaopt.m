...
... % Optimization model
    ...
    'maxGen', 1500,...            % maximum generation
...
... % Genetic algorithm operators
    'crossover', {{'VarLengthChromosome', 0.3}},...         % crossover operator (Ratio=1.2)
    'mutation', {{'gaussian',0.75, 0.5}},...          % mutation operator (scale=0.1, shrink=0.5)
