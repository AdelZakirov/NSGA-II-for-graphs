...
% NofEdges = 4552;
% NofEdges = sum(cellfun(@length, list_skyrim))/2;
load('falloutnv_adj_list.mat')
% load('EcoliAdjList.mat')
result = nsga2(options,list_falloutnv);                % begin the optimization!
% result = nsga2(options,EcoliAdjList);
