...
... % Genetic algorithm operators
    'crossover', {{'VarLengthChromosome', 0.9}},...         % crossover operator (Ratio=1.2)
    'mutation', {{'gaussian',0.25, 0.5}},...          % mutation operator (scale=0.1, shrink=0.5)
